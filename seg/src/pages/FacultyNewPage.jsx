...
const deans = [
    { id: 6, name: 'Dr. Nirupma Gupta', role: 'Dean, Sharda School of Medical Sciences & Research', image: aboutBg },
    { id: 7, name: 'Prof. (Dr.) Ritu S. Sood', role: 'Dean, Sharda School of Media, Film and Entertainment', image: institutionsBg },
    { id: 8, name: 'Prof. (Dr.) Dolly Wattal Dhar', role: 'Dean, Sharda School of Agricultural Sciences', image: campusBg },
    { id: 9, name: 'Prof. (Dr.) Debasis Mallik', role: 'Dean, Sharda School of Business Studies', image: facultyBg },
    { id: 10, name: 'Prof. (Dr.) Rishikesh Dave', role: 'Dean, Sharda School of Law', image: campusBg },
    { id: 11, name: 'Prof. (Dr.) Pallavi Gupta', role: 'Dean, Sharda School of Engineering & Science', image: aboutBg },
    { id: 12, name: 'Prof. (Dr.) Geetha Ganesan', role: 'Dean, Sharda School of Computing Science & Engineering', image: institutionsBg },
    { id: 13, name: 'Prof. (Dr.) Anviti Gupta', role: 'Professor & Dean', image: facultyBg },
];
    ...
    return (
        <div style={{ background: '#fcfdfe', minHeight: '100vh' }}>
                    ...
                    {featuredFaculty.map(f => (
                        <article className="fnp-card" key={f.id}>
                            ...
                            <div className="fnp-card__body">
                                ...
                                <button onClick={() => navigate(`/faculty/${f.id}`)} className="fnp-card__btn">View Profile <ArrowRight /></button>
                            </div>
                        </article>
                    ))}
                </div>
            ...
            <section className="fnp-section">
                ...
                <div className="fnp-grid">
                    {deans.map(d => (
                        <article className="fnp-leader" key={d.id} onClick={() => navigate(`/faculty/${d.id}`)} style={{ cursor: 'pointer' }}>
