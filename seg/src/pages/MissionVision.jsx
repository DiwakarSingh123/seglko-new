...
const MissionVision = () => {
  ...
  useEffect(() => {
    fetch('/api/settings')
      .then(res => res.json())
      .then(res => { if (res?.aboutVisionMission) setData(res.aboutVisionMission); })
      .catch(() => {});
  }, []);
      ...
      <section className="mv-content">
        <div className="mv-content__header">
          <div className="mv-content__header-left">
            ...
            <h2 className="mv-content__title">{data.mainHeading}</h2>
          </div>
          <div className="mv-content__header-right">
            <p className="mv-content__intro">{data.missionDescription}</p>
          </div>
        </div>
        ...
        <div className="mv-card">
          ...
          <div className="mv-card__body">
            ...
            <p className="mv-card__text">{data.missionDescription}</p>
          </div>
        ...
        <div className="mv-card mv-card--reverse">
          <div className="mv-card__body">
            ...
            <div className="mv-card__title-line"></div>
            <p className="mv-card__text">{data.visionDescription}</p>
          </div>
          <div className="mv-card__visual">
